      ...
      <div className="relative z-10 container mx-auto px-6 pt-24 pb-16 flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 text-center lg:text-left animate-fade-up">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-serif font-bold leading-tight mb-6">
            MD. Shinha{" "}
            <span className="text-gradient-gold">Sarder</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start text-sm text-muted-foreground mb-8">
            <span className="flex items-center gap-1.5">
              <Calendar size={14} className="text-primary" /> Nov 05, 2004
            </span>
            <span className="flex items-center gap-1.5">
              <MapPin size={14} className="text-primary" /> Khulna, Bangladesh
            </span>
          </div>

          <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
            <a
              href="mailto:contact@shinhasarder.com"
              className="inline-flex items-center gap-2 bg-gradient-gold text-primary-foreground px-6 py-3 rounded-lg font-medium hover:opacity-90 transition-opacity shadow-gold"
            >
